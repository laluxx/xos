...
awful.rules.rules = {
    ...
    -- Fixed terminal geometry for floating terminals
    {
        ...
        properties = { width = screen_width * 0.6, height = screen_height * 0.8, ontop = true}
    },
    ...
    -- File managers
    {
        ...
        properties = { floating = true, width = screen_width * 0.45, height = screen_height * 1, ontop = false,}
